...
<head>
    ...
    <meta name="description" content="Online Users Monitoring - DLHS Admin">
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
        <section class="wrapper">            
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-users"></i> Online Users & Activity</h3>
                    <ol class="breadcrumb">
                        <li><i class="fa fa-home"></i><a href="index.php">Home</a></li>
                        <li><i class="fa fa-users"></i>Online Users</li>
                    </ol>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-card dlhs-card">
                        <div class="section-header" style="cursor: pointer;" onclick="toggleAllUsersList()">
                            ...
                            <button class="refresh-btn btn-dlhs" onclick="event.stopPropagation(); loadAllUsers()">
                ...
                <div class="col-lg-12">
                    <div class="section-card dlhs-card">
                        <div class="section-header">
                            ...
                            <button class="refresh-btn btn-dlhs" onclick="loadOnlineUsers('student')">
                                <i class="fa fa-refresh"></i> Refresh
                            </button>
                        </div>
                ...
                <div class="col-lg-12">
                    <div class="section-card dlhs-card">
                        <div class="section-header">
                            ...
                            <button class="refresh-btn btn-dlhs" onclick="loadOnlineUsers('staff')">
                                <i class="fa fa-refresh"></i> Refresh
                            </button>
                        </div>
                        <div id="onlineStaff">
                ...
                <div class="col-lg-12">
                    <div class="section-card dlhs-card">
                        <div class="section-header">
                            ...
                            <button class="refresh-btn btn-dlhs" onclick="loadOnlineUsers('admin')">
                                <i class="fa fa-refresh"></i> Refresh
                            </button>
                        </div>
                        <div id="onlineAdmins">
