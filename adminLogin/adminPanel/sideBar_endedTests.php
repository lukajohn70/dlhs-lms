        ...
        <ul class="sidebar-menu">                
            ...
            <li class="sub-menu active">
                ...
                <ul class="sub">
                    ...
                    <li><a class="" href="view_teacher_questions.php">View Teacher Questions</a></li>
                    ...
                    <li><a class="" href="endedTests.php" style="background-color:red; color:white;">Tests ended</a></li>
			...
			<li class="sub-menu">
                ...
                <ul class="sub">
					...
					<li><a class="" href="assignClassTeachersForm.php">Class teacher Assign.</a></li>
					<li><a class="" href="assignPrincipalForm.php">Principal Assignment</a></li>
