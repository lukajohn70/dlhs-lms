...
<center><img src="../img/NWRILogo.jpg" class="resize" alt="DLHS logo"></img></center>		
<h2><center>Login</center></h2>
        ...
        <div class="form-group">
        	<input type="text" class="form-control" id="username" name="adminUsername" placeholder="Email" required="required">
        </div>
		<div class="form-group">
