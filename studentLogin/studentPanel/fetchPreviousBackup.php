...
session_start();
	...
	{    
		...
		echo json_encode(array('q' => $question, 'a' => $optionA, 'b' => $optionB, 'c' => $optionC, 'd' => $optionD, 'e' => $optionE, 'k' => $currentIndexToDisplay, 'f' => $totalQuestions, 'g' => $optionAnsweredQues, 'h' => $remainingTimeToReturn, 'j' => $logoutStatus));
	}
?>