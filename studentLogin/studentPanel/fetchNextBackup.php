...
session_start();
	...
	{    
		...
		echo json_encode(array('q' => $question, 'a' => $optionA, 'b' => $optionB, 'c' => $optionC, 'd' => $optionD, 'e' => $optionE, 'f' => $currentIndexToDisplay, 'g' => $totalQuestions, 'h' => $optionAnsweredQues, 'j' => $remainingTimeToReturn, 'k' => $logoutStatus));
	}
?>